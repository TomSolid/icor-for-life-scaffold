...
created: 2026-08-28
owner: nolan
uses: ["[[SOP-007-hire-a-new-agent]]", "[[SOP-011-import-or-align-an-external-agent]]", "[[GL-004-naming-rules]]", "[[GL-005-code-vs-instructions]]"]
---

# SOP-012 Convert an external skill into scaffold shape
...
| A role in disguise ("you are a...") | agent ruling via [[SOP-011-import-or-align-an-external-agent|SOP-011]] (hire / merge / extract) | `Agents/` |
...
2. [JUDGEMENT] Nolan drafts the decomposition per the table above,
   ...
   write.**
3. Write the pieces:
   - SOPs and Guidelines get the next free number ([[GL-004-naming-rules|GL-004]] naming) and
     frontmatter per [[GL-002-frontmatter-conventions|GL-002]]; foreign prose is rewritten to this
   ...
   - Scripts land in `Scripts/`, are made ROOT-relative (no absolute
     ...
     `run-red-tests.py` and is watched go red ([[GL-005-code-vs-instructions|GL-005]] rule 4).
...
5. The manifest ([[WS-004-import-and-convert-external-knowledge|WS-004]] shape) records source, license note if the
