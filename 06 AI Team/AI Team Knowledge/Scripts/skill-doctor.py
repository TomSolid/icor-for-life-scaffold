...
(`03 WiP/2026-09-14-scaffold-skills-hooks-audit/report.md`, Nolan's hire
...
-------------------------------------------
  ...
  5  host    host-only frontmatter keys (allowed-tools, shell,
             user-invocable, disable-model-invocation, model, argument-hint)
             appear only inside a host adapter folder (`.claude/`, `.codex/`,
             `.agents/`). In the canonical home they are portability debt.
