...
allowed-tools: Bash
---
<!-- GENERATED by scaffold-init.py from `06 AI Team/AI Team Knowledge/Workstreams/WS-1005-checkpoint.md`. content-hash:85ea35df970c. Do not hand-edit: change the source and re-run the generator. -->
...
- `06 AI Team/AI Team Knowledge/Scripts/link-dates-to-daily-notes.py`
