...
<!-- GENERATED by scaffold-init.py from `06 AI Team/AI Team Knowledge/Scripts/hooks-rules.json`. content-hash:ceba823ebad2. Do not hand-edit: change the source and re-run the generator. -->
...
Rendered hooks block content-hash: `45463be31127`
